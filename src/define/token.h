...
#define YULANG_KEYWORDS(e)                                                    \
  e(Var, "var") e(Let, "let") e(Def, "def") e(Declare, "declare")             \
      e(Type, "type") e(As, "as") e(SizeOf, "sizeof") e(Struct, "struct")     \
          e(Enum, "enum") e(Asm, "asm") e(Int8, "i8") e(Int16, "i16")         \
              e(Int32, "i32") e(Int64, "i64") e(UInt8, "u8") e(UInt16, "u16") \
                  e(UInt32, "u32") e(UInt64, "u64") e(ISize, "isize")         \
                      e(USize, "usize") e(Bool, "bool") e(Float32, "f32")     \
                          e(Float64, "f64") e(True, "true") e(False, "false") \
                              e(Null, "null") e(Import, "import") e(          \
                                  Public, "public") e(Extern, "extern")       \
                                  e(Volatile, "volatile") e(Inline, "inline") \
                                      e(If, "if") e(Else, "else")             \
                                          e(When, "when") e(While, "while")   \
                                              e(For, "for") e(In, "in")       \
                                                  e(Break, "break")           \
                                                      e(Continue, "continue") \
                                                          e(Return, "return")
...
#define YULANG_OPERATORS(e)                                                    \
  e(Add, "+", 90) e(Sub, "-", 90) e(Mul, "*", 100) e(Div, "/", 100) e(         \
      Mod, "%", 100) e(Equal, "==", 60) e(NotEqual, "!=", 60) e(Less, "<", 70) \
      e(LessEqual, "<=", 70) e(Great, ">", 70) e(GreatEqual, ">=", 70)         \
          e(LogicAnd, "&&", 20) e(LogicOr, "||", 10) e(LogicNot, "!", -1)      \
              e(And, "&", 50) e(Or, "|", 30) e(Not, "~", -1) e(Xor, "^", 40)   \
                  e(Shl, "<<", 80) e(Shr, ">>", 80) e(Access, ".", -1)         \
                      e(Assign, "=", 0) e(AssAdd, "+=", 0) e(AssSub, "-=", 0)  \
                          e(AssMul, "*=", 0) e(AssDiv, "/=", 0)                \
                              e(AssMod, "%=", 0) e(AssAnd, "&=", 0)            \
